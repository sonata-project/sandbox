...
Scenario: Check gallery admin pages when not connected
  When I go to "admin/app/gallery/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check gallery admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/gallery/list"
  Then I should see "Filters"

Scenario: Add a new gallery with some errors
  When I am connected with "admin" and "admin" on "admin/app/gallery/create?context=default&uniqid=f155592a220e"
  And I press "Create"
