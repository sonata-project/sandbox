...
class MediaController
{
     ...
     *
     *
     * @Rest\Get("/media/{id}", name="get_medium")
     *
     * @View(serializerGroups={"sonata_api_read"}, serializerEnableMaxDepthChecks=true)
     *
     * @param $id
     ...
     *
     *
     * @Rest\Get("/media/{id}/formats", name="get_medium_formats")
     *
     * @param $id
     *
     * @return array
     ...
     *
     *
     * @Rest\Get("/media/{id}/binaries/{format}", name="get_medium_binary")
     *
     ...
     *
     *
     * @Rest\Delete("/media/{id}", name="delete_medium")
     *
     ...
     *
     *
     * @Rest\Put("/media/{id}", name="put_medium")
     *
     * @param int     $id      A Medium identifier
     ...
     *
     *
     * @Rest\Post("/media/providers/{provider}/media", name="post_provider_medium", requirements={"provider"="[A-Za-z0-9.]*"})
     *
     ...
     *
     *
     * @Rest\Put("/media/{id}/binary/content", name="put_medium_binary_content")
     *
     * @View(serializerGroups={"sonata_api_read"}, serializerEnableMaxDepthChecks=true)
     *
     * @param $id
