...
Scenario: Add a new media with errors
  When I am connected with "admin" and "admin" on "admin/sonata/media/media/create?provider=sonata.media.provider.youtube&context=default&uniqid=4f155592a220e"
  And I press "Create"
...
Scenario: Add a new dailymotion video
  When I am connected with "admin" and "admin" on "admin/sonata/media/media/create?provider=sonata.media.provider.dailymotion&context=default&uniqid=4f155592a220e"
