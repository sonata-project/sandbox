...
Scenario: Check page admin pages when not connected
  When I go to "admin/app/page/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check page admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/page/list"
  Then I should see "Filters"

Scenario: Add a new page with some errors
  When I am connected with "admin" and "admin" on "admin/app/page/create?uniqid=f155592a220e"
...
Scenario: Export JSON data
  When I am connected with "admin" and "admin" on "admin/app/page/list?filter[site][value]=1"
  And I follow "JSON"
  Then the response status code should be 200
