...
Scenario: Check comment admin pages when not connected
  When I go to "admin/app/postcomment/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check comment admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/postcomment/list"
  Then I should see "Filters"

Scenario: Add a new comment with some errors
  When I am connected with "admin" and "admin" on "admin/app/postcomment/create?uniqid=f155592a220e"
  And I press "Create"
