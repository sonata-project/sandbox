...
Scenario: Check tag admin pages when not connected
  When I go to "admin/app/tag/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check category admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/tag/list"
  Then I should see "Filters"

Scenario: Add a new tag with some errors
  When I am connected with "admin" and "admin" on "admin/app/tag/create?uniqid=f155592a220e"
  And I press "Create"
