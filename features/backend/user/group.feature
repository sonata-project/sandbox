...
Scenario: Check group admin pages when not connected
  When I go to "admin/app/group/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check group admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/group/list"
  Then I should see "Filters"

Scenario: Add a new group with some errors
  When I am connected with "admin" and "admin" on "admin/app/group/create?uniqid=f155592a220e"
  And I press "Create"
