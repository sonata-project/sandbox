...
Scenario: Check category admin pages when not connected
  When I go to "admin/app/category/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check category admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/category/list"
  Then I should see "Filters"

Scenario: Add a new category with some errors
  When I am connected with "admin" and "admin" on "admin/app/category/create?uniqid=f155592a220e"
  And I press "Create"
