...
class WebApiContext implements Context
{
    ...
    {
        \PHPUnit\Framework\Assert::assertSame((int) $code, $this->browser->getLastResponse()->getStatusCode());
    }
    ...
    {
        \PHPUnit\Framework\Assert::assertRegExp('/'.preg_quote($text).'/', $this->browser->getLastResponse()->getContent());
    }
    ...
    {
        \PHPUnit\Framework\Assert::assertNotRegExp('/'.preg_quote($text).'/', $this->browser->getLastResponse()->getContent());
    }
    ...
    public function theResponseShouldContainJson(PyStringNode $jsonString)
    {
        ...
        \PHPUnit\Framework\Assert::assertCount(count($etalon), $actual);
        foreach ($actual as $key => $needle) {
            \PHPUnit\Framework\Assert::assertArrayHasKey($key, $etalon);
            \PHPUnit\Framework\Assert::assertEquals($etalon[$key], $actual[$key]);
        }
    }
