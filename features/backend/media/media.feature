...
Scenario: Check media admin pages when not connected
  When I go to "admin/app/media/list"
  Then the response status code should be 200
  And I should see "Authentication"

Scenario: Check media admin pages when connected
  When I am connected with "admin" and "admin" on "admin/app/media/list"
  Then I should see "Filters"

Scenario: Add a new media with errors
  When I am connected with "admin" and "admin" on "admin/app/media/create?provider=sonata.media.provider.youtube&context=default&uniqid=f155592a220e"
  And I press "Create"
...
Scenario: Add a new dailymotion video
  When I am connected with "admin" and "admin" on "admin/app/media/create?provider=sonata.media.provider.dailymotion&context=default&uniqid=f155592a220e"
...
Scenario: Add a Media, then delete it immediately
  When I am connected with "admin" and "admin" on "admin/app/media/create?provider=sonata.media.provider.image&context=default&uniqid=f155592a220e"
