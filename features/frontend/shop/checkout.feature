...
Feature: Checkout process
  ...
  As a customer
  I want to be able to use the checkout process

  @200 @checkout @empty @basket
  Scenario: No checkout for empty basket
    ...
    And I should not see "Next step"

  @200 @checkout @notloggedin
  ...
  @200 @checkout @loggedin
  Scenario: Checkout with one product in the basket when logging in
    Given I am connected with "behat_user" and "behat_user" on "shop/catalog"
    And I follow "Goodies"
    And I follow "Plushes"
    And I follow "PHP plush"
    And I fill in "add_basket_quantity" with "3"
